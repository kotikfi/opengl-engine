...
void ModelTerrain::createVAO(GLuint VBO)
{
...
void ModelTerrain::loadModel()
{
	...
	const aiScene* scene = importer.ReadFile("models/teren.obj", importOptions);
...
ModelTerrain::ModelTerrain(Shader* shader)
{
	this->shader = shader;
	...
	createVBO(vertices);
	createVAO(this->VBO);
	//textureID = shader->setTexture("models/grass.png");
	//textureID = shader->setTexture("textures/grass.png"); desert_sand_texture.jpg
	textureID = shader->setTexture("textures/desert_sand_texture2.jpg");


}

void ModelTerrain::render(glm::mat4 trans)
{
